      ...
      <div className="container">
        ...
        <form className="main-form" >
          <label htmlFor="url">
            ...
            <button onClick={handleSubmit} className="btn" type="submit">Get Comments and Feedback</button>
          </label>
        ...
        <label htmlFor="prompt">
          <p>Enter Prompt: </p>
          <textarea className="text-area" name="" id="prompt"></textarea>
        </label>
        <button onClick={handleSubmitFeedback} className="btn" type="submit">Get Comments and Feedback</button>
        </form>
      </div>
    )
}

export default YoutubeScrapper